...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2025 a las 18:54:21
...
(3, 'SURTIDOR GASOIL 01', 16290.00, 1, 'ACTIVO', 1, '2025-11-23 13:24:37', '2025-12-07 07:37:01'),
(4, 'SURTIDOR GASOLINA 01', 3368.00, 2, 'ACTIVO', 1, '2025-11-25 17:13:26', '2025-12-07 07:37:02');
...
(1, 'ADMIN', 'María', 'González', '12345678', '$2a$10$JDEm4cUMTzU3W.LkaIvKpOeEd4RqGnllntsF1lvhWYuAEu.tsfAzK', 'ACTIVO', '2025-11-19 10:15:00', '2025-12-09 12:18:53', '2025-11-24 15:02:52', 1),
...
--
ALTER TABLE `despachos`
  MODIFY `id_despacho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=384;
...
--
ALTER TABLE `gerencias`
  MODIFY `id_gerencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `vehiculos`
  MODIFY `id_vehiculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `cargas_cisterna`
  ADD CONSTRAINT `cargas_cisterna_ibfk_691` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id_vehiculo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cargas_cisterna_ibfk_692` FOREIGN KEY (`id_tanque`) REFERENCES `tanques` (`id_tanque`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cargas_cisterna_ibfk_693` FOREIGN KEY (`id_almacenista`) REFERENCES `almacenistas` (`id_almacenista`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cargas_cisterna_ibfk_694` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cargas_cisterna_ibfk_695` FOREIGN KEY (`id_cierre`) REFERENCES `cierres_inventario` (`id_cierre`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `cierres_inventario`
--
ALTER TABLE `cierres_inventario`
  ADD CONSTRAINT `cierres_inventario_ibfk_316` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cierres_inventario_ibfk_317` FOREIGN KEY (`id_tanque`) REFERENCES `tanques` (`id_tanque`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `despachos`
--
ALTER TABLE `despachos`
  ADD CONSTRAINT `despachos_ibfk_991` FOREIGN KEY (`id_dispensador`) REFERENCES `dispensadores` (`id_dispensador`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_992` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id_vehiculo`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_993` FOREIGN KEY (`id_chofer`) REFERENCES `choferes` (`id_chofer`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_994` FOREIGN KEY (`id_gerencia`) REFERENCES `gerencias` (`id_gerencia`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_995` FOREIGN KEY (`id_almacenista`) REFERENCES `almacenistas` (`id_almacenista`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_996` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `despachos_ibfk_997` FOREIGN KEY (`id_cierre`) REFERENCES `cierres_inventario` (`id_cierre`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `mediciones_tanques`
  ADD CONSTRAINT `mediciones_tanques_ibfk_412` FOREIGN KEY (`id_tanque`) REFERENCES `tanques` (`id_tanque`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mediciones_tanques_ibfk_413` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mediciones_tanques_ibfk_414` FOREIGN KEY (`id_cierre`) REFERENCES `cierres_inventario` (`id_cierre`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `vehiculos`
  ADD CONSTRAINT `vehiculos_ibfk_472` FOREIGN KEY (`id_gerencia`) REFERENCES `gerencias` (`id_gerencia`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `vehiculos_ibfk_473` FOREIGN KEY (`id_marca`) REFERENCES `marcas` (`id_marca`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vehiculos_ibfk_474` FOREIGN KEY (`id_modelo`) REFERENCES `modelos` (`id_modelo`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
